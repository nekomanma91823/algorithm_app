...
const PatternPage: React.FC<PatternPageProps> = ({ params }) => {
  ...
  const getVisualizer = () => {
    // return <Mermaid chart={currentPattern.uml} />;
    return null;
  };
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto relative bg-background text-foreground">
      ...
      <section className="mb-12 p-6 rounded-lg bg-card neumorphic-shadow">
        ...
        <div className="p-6 rounded-md neumorphic-shadow-inset bg-card min-h-[400px] flex justify-center items-center">
          {getVisualizer()}
        </div>
      </section>
      ...
      <section className="mb-8 p-6 rounded-lg bg-card neumorphic-shadow">
        ...
        <p className="text-lg font-medium mb-2">
          {renderTextWithTerms(currentPattern.description)}
        </p>
        <p className="text-lg font-medium mb-2">
          {renderTextWithTerms(currentPattern.example)}
        </p>
      </section>
      ...
      <section className="mb-8 p-6 rounded-lg bg-card neumorphic-shadow">
        ...
        <div className="rounded-md bg-card">
          {currentPattern.structure.map((step: string, index: number) => (
