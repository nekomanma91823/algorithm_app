    ...
    <div className="p-6 bg-white rounded-lg border">
      ...
      <div className="bg-yellow-50 p-4 rounded-lg mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white p-3 rounded border">
            ...
            <div className="text-xs text-gray-500 mt-1">
              {convertToBase(bitOperationA, 2).padStart(8, "0")}
              <br />
              {convertToBase(bitOperationB, 2).padStart(8, "0")}
              <br />
      ...
      <div className="bg-indigo-50 p-4 rounded-lg">
        ...
        <div className="text-sm text-indigo-700 space-y-2">
          <div>
            <strong>16進数:</strong> カラーコード #FF0000 (赤色)
          </div>
          <div>
            <strong>2進数:</strong> ファイルの権限設定 755 = rwxr-xr-x
          </div>
          <div>
            <strong>ビット演算:</strong> フラグ管理、マスク処理、高速計算
          </div>
          <div>
            <strong>シフト演算:</strong> 2倍/半分の高速計算、ビットパターン移動
          </div>
        </div>
      </div>
    </div>
